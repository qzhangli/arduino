...
char checkForWinner( unsigned char n ) {
      ...
      if(gameBoard[0]+gameBoard[1]+gameBoard[2] == 3) { lcd.string(1,"\\[164xYOU WIN");  showWinningLine(1); return 1; }
      if(gameBoard[0]+gameBoard[4]+gameBoard[8] == 3) {  lcd.string(1,"\\[164xYOU WIN");  showWinningLine(2);return 2;}
      if(gameBoard[0]+gameBoard[3]+gameBoard[6] == 3) {  lcd.string(1,"\\[164xYOU WIN");  showWinningLine(3); return 3;}      
      if(gameBoard[3]+gameBoard[4]+gameBoard[5] == 3) {  lcd.string(1,"\\[164xYOU WIN");  showWinningLine(4); return 4;}
      if(gameBoard[1]+gameBoard[4]+gameBoard[7] == 3) { lcd.string(1,"\\[164xYOU WIN");  showWinningLine(5); return 5;}
      if(gameBoard[2]+gameBoard[5]+gameBoard[8] == 3) {  lcd.string(1,"\\[164xYOU WIN");  showWinningLine(6); return 6;}    
      if(gameBoard[2]+gameBoard[4]+gameBoard[6] == 3) {  lcd.string(1,"\\[164xYOU WIN");  showWinningLine(7); return 7;}          
      if(gameBoard[6]+gameBoard[7]+gameBoard[8] == 3) {  lcd.string(1,"\\[164xYOU WIN");  showWinningLine(8); return 8;}        
...
void showMainScreen( void ) {
  ...
  lcd.string(1,"YOU");
  lcd.staticText(10, 38, 0, 80, 20, 8, 1, 1);
  lcd.color(WHITE);
  lcd.xy(35,200);
